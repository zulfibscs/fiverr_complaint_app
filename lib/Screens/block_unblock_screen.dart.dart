          ...
          children: [
            ...
            Expanded(
              child: TabBarView(
                controller: _tabController,
                children: [
                  CustomListTile(userName: 'Zulfi', tagList: '_@Fiverr_id', userEmail: 'abc@gmail.com', urlImg: 'assets/images/z.jpg',btn1Lable: "Block",isBtn2Visible: false,btn1Fun: (){
